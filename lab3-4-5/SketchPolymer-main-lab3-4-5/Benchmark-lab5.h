...
uint64_t target_list[660000];
double answer_list[660000];
...
public:
    ...
    void Run(int memory)
    {
        SketchPolymer<uint64_t, uint64_t> *sketchpolymer = new SketchPolymer<uint64_t, uint64_t>(memory, 3, 5, 3, 2, 50, 2,0.20,0.30,0.40,0.10);
